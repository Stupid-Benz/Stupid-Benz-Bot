    ...
    public class Help_Commands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task General()
        {
            ...
            embed.AddField("1\u20E3 Ping", "Give the Ping Time")
                ...
                .AddField("4\u20E3 Bot-Info", "Give the Bot Information")
                .AddField("5\u20E3 Server-Info", "Give the Server Information")
                .AddField("6\u20E3 Search-Role", "Give the Role Information")
                .WithAuthor(Context.Client.CurrentUser)
                .WithColor(Color.Blue)
                .WithCurrentTimestamp();
            await ReplyAsync("", false, embed.Build());
        ...
        public async Task Play()
        {
            ...
            {
                Title = "Play",
                Description = "```Help > Command > Play```"
            };
            embed.AddField("1\u20E3 Slot", "Quadratic Equation")
                .WithAuthor(Context.Client.CurrentUser)
                .WithColor(Color.Blue)
                .WithCurrentTimestamp();
            await ReplyAsync("", false, embed.Build());
        ...
        public async Task Slot()
        {
            ...
            {
                Title = "Ping",
                Description = "```Help > Command > Play > Slot```"
            };
            embed.AddField("How to Use", "=Play Slot")
                .AddField("Usage", "Just Play Slot")
                .AddField("Caution", "No Caution")
                .AddField("Alias", "No Alias")
                .WithAuthor(Context.Client.CurrentUser)
                .WithColor(Color.Blue)
