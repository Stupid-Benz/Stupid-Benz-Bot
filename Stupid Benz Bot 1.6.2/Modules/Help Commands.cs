    ...
    public class Help_Commands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Help()
        {
            ...
            embed.WithAuthor(Context.Client.CurrentUser)
                ...
                .AddField("base16", "Change Base 10 or 2 to Base 16 Function", true)
                .AddField("base2", "Change Base 10 or 16 to Base 2 Function", true)
        ...
        public async Task HelpBase16()
        {
            ...
            embed.WithAuthor(Context.Client.CurrentUser)
                .WithColor(Color.Blue)
                .WithCurrentTimestamp()
                .AddField("How to use", "=Base16 [Base 10 Number] [Mode, default as 10]")
                .AddField("Usage", "Change Base 10 or 2 to Base 16 Function")
                .AddField("Caution!", "Mode is 2, which for 'Base 2', and 10, which for 'Base 10', these two mode")
                .AddField("Alias", "16");
            await ReplyAsync("", false, embed.Build());
        }
        ...
        public async Task HelpBase2()
        {
            ...
            embed.WithAuthor(Context.Client.CurrentUser)
                .WithColor(Color.Blue)
                .WithCurrentTimestamp()
                .AddField("How to use", "=Base2 [Base 10 Number] [Mode, default as 10]")
                .AddField("Usage", "Change Base 10 or 16 to Base 2 Function")
                .AddField("Caution!", "Mode is 10, which for 'Base 10', and 16, which for 'Base 16', these two mode")
                .AddField("Alias", "2");
            await ReplyAsync("", false, embed.Build());
        }
